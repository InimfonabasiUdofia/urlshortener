...
export default function Details() {
    ...
    const detailFunction = useCallback(async (): Promise<void> => {
        try {
            setLoading(true);
            setError(null);
        ...
        <>
            ...
            <div className="min-h-screen bg-black p-4 lg:mt-15 mt-13 py-8">
                <div className="mx-auto md:px-20 lg:px-25">
                    ...
                    {error && (
                        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-6 mt-6">
                            <p>Error: {error}</p>
                        </div>
                    )}
                    ...
                    <div className="space-y-4 pt-5">
                        {loading ? (
                            ...
                            <div className="bg-white shadow p-12 text-center">
                                <p className="text-gray-600">No links found. Create your first shortened URL!</p>
                            </div>
                        ) : (
                            links.map((link) => (
